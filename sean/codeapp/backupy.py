...
def index(request):
	if request.method =='POST':
		...
		return render(request, 'home.html',{'mess':user,'matching':both,'current':current_feed,'res':res})
	...
	return render(request, 'home.html',{'mess':user,'matching':both,'current':current_feed,'res':res,'all_chat':all_chat,'ss':ss})
